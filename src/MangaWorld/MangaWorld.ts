import {
    ...
    TagSection,
    PartialSourceManga,
    HomeSectionType, // Assicurati che questo sia importato
...
export const MangaWorldInfo: SourceInfo = {
    version: '3.4.1', // Bump minore per test UI
    name: 'MangaWorld',
...
export class MangaWorld implements SearchResultsProviding, MangaProviding, ChapterProviding, HomePageSectionsProviding { 
    ...
    async getHomePageSections(sectionCallback: (section: HomeSection) => void): Promise<void> {
        ...
        // 1. TOP MONTH -> Vetrina Grande (singleRowLarge)
        const sectionMonth = App.createHomeSection({
            id: 'month',
            title: 'Top Mensile 🔥',
            containsMoreItems: false, // Solitamente top month è fissa a 10 item
            type: HomeSectionType.singleRowLarge, 
        })

        // 2. LATEST -> Scroll Infinito (continuous)
        ...
        // 3. TRENDING -> Sidebar Normale (singleRowNormal)
        ...
        // Parsing usando la logica stabile 3.4.0
